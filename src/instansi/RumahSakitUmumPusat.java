...
public class RumahSakitUmumPusat extends Instansi {
    public String namaInstansi;

    public RumahSakitUmumPusat(String instansi, String namaInstansi, String provinsi, String kota, String kecamatan, String kelurahan, String alamat) {
