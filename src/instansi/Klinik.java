...
public class Klinik extends Instansi {
    public String namaInstansi;

    public Klinik(String instansi, String namaInstansi, String provinsi, String kota, String kecamatan, String kelurahan, String alamat) {
    ...
    public void tampilkanInfo() {
        ...
        /*System.out.println("Klinik " + getInstansi());
